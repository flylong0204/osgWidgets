...
void AdapterWidget::mouseReleaseEvent(QMouseEvent* event)
{
    ...
    _SetKeyboardModifiers(event);
    _graphicsWindowembedded->getEventQueue()->mouseButtonRelease(event->x()*_devicePixelRatio, event->y()*_devicePixelRatio, button);
}

void AdapterWidget::mouseMoveEvent(QMouseEvent* event)
{
    _SetKeyboardModifiers(event);
    _graphicsWindowembedded->getEventQueue()->mouseMotion(event->x()*_devicePixelRatio, event->y()*_devicePixelRatio);
}
...
void AdapterWidget::mouseDoubleClickEvent(QMouseEvent *event)
{
    ...
    _SetKeyboardModifiers(event);
    _graphicsWindowembedded->getEventQueue()->mouseDoubleButtonPress(event->x()*_devicePixelRatio, event->y()*_devicePixelRatio, button);
}
...
ShadowViewBasics::ShadowViewBasics(QWidget *parent)
    : AdapterWidget(parent)
{

}

ShadowViewBasics::~ShadowViewBasics()
{

}

void ShadowViewBasics::initializeGL()
{
...
void ShadowViewBasics::paintGL()
{
    frame();
}

bool ShadowViewBasics::event(QEvent* event)
{
